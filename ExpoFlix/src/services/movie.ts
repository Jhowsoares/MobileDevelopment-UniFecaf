...
export const Movies = [
  ...
  },
  {
    ...
    description:
    "When Hellboy, Liz Sherman, and Abe Sapien are assigned to investigate the ghost-infestedmansion of a publicity-hound billio...loodbath, Hellboy will have to battle harpies, hellhounds, a giant werewolf, and even the ferocious goddess Hecate herself.",
    poster:
